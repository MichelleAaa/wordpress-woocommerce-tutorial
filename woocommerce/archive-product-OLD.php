...
<div class="container">
	<div class="row">
        <!-- We change the order to move the sidebar to the bottom on smaller devices -->
		<div class="col-lg-3 col-md-4 order-2 order-md-1">
            <!-- Note that we moved this section from the bottom to the beginning to move the sidebar to the left: -->
			<?php
